...
//    Stepper(512);
    ...
    while (1) {
        ...
        if (comb1 == 0x6C && comb2 == 0x76 && comb6 == 0x6C && comb7 == 0x76) { //ascii l && v
...
//            step(stepvar);
        ...
        if (comb1 != 0x6C && comb1 != 0x73 && comb1 != 0x00) { //ascii l, ascii s
            empty_comb();
        } else if (comb2 != 0x76 && comb2 != 0x73 && comb2 != 0x00) { //ascii v, ascii s
            empty_comb();
        }
    }
